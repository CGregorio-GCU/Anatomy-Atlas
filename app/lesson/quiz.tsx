...
export const Quiz = ({
    ...
    const [activeIndex, setActiveIndex] = useState(() => {
        ...
        // ternary operater of the index of the non-completed challenges (each question)
    ...
    // this updates the current index, but doesn't account for other challenges
    const onNext = () => {
    ...
    // if there is no challenges left in the page
    if (!challenge) {
        return (
          <>
            {finishAudio}
