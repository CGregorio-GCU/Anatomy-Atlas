...
const buttonVariants = tv({
	base: "inline-flex items-center justify-center rounded-xl text-sm font-bold whitespace-nowrap ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 uppercase tracking-wide",
	variants: {
		variant: {
